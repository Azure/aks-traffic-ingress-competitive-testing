...
./modules/vegeta/output/output.sh > ./scenarios/results/restarting_backend_rps_result.json

echo "Test results saved to ./scenarios/results/restarting_backend_rps_result.json"