...
./modules/vegeta/output/output.sh > ./scenarios/result/restarting_backend_rps_result.json

echo "Test results saved to ./scenarios/result/restarting_backend_rps_result.json"