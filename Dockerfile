...
RUN printf '%s\n' \
    ...
    '  echo "  docker run <image> module/vegeta/run http://localhost:8080 50 30s"' \
...
# docker run ghcr.io/azure/aks-traffic-ingress-competitive-testing module/vegeta/run http://localhost:8080 50 30s
